  ...
  useEffect(() => {
    async function fetchStats() {
      try {
        ...
        setStats((s) => ({ ...s, loading: false, error: "Failed to fetch activity stats" }))
      }
    }
    fetchStats()
  }, [])
  ...
  if (stats.loading) {
    return (
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="text-lg sm:text-xl">Activity Stats</CardTitle>
          <CardDescription className="text-sm sm:text-base">
            The data displayed in the Stats section of the activity is now also visualized in a pie chart format for
